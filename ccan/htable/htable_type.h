...
#define HTABLE_DEFINE_TYPE_STRUCT(name)					\
...
#define HTABLE_DEFINE_TYPE(type, keyof, hashfn, eqfn, name)		\
	HTABLE_DEFINE_TYPE_STRUCT(name)					\
	HTABLE_DEFINE_TYPE_FUNCS(type, keyof, hashfn, eqfn, name)

/**
 * HTABLE_INIT - initializer for a htable defined with HTABLE_DEFINE_TYPE
 * @self_: an expression that resolves to the htable being initialized
