...
int main(void)
{
	...
	ok_eq(bheap_depth(1), 1);

	ok_eq(bheap_depth(2), 2);
	ok_eq(bheap_depth(3), 2);

	ok_eq(bheap_depth(4), 3);
	ok_eq(bheap_depth(5), 3);
	ok_eq(bheap_depth(6), 3);
	ok_eq(bheap_depth(7), 3);

	ok_eq(bheap_depth(8), 4);
	ok_eq(bheap_depth(9), 4);
	ok_eq(bheap_depth(10), 4);
	ok_eq(bheap_depth(11), 4);
	ok_eq(bheap_depth(12), 4);
	ok_eq(bheap_depth(13), 4);
	ok_eq(bheap_depth(14), 4);
	ok_eq(bheap_depth(15), 4);

	ok_eq(bheap_depth(16), 5);
